/**
 * Deterministic JSON serialization used for manifest signing and hashing.
 *
 * Rules:
 ...
 *
 * NOTE: intentionally duplicated from @aeg-clouddfir/database — this package
 * must not depend on the database package (or Prisma) by design.
 */
