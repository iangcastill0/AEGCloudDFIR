...
export function testConfig(overrides: Partial<AppConfig> = {}): AppConfig {
  return {
    ...
    CDFIR_DROPBOX_CLIENT_ID: 'dropbox-app-key',
    CDFIR_DROPBOX_CLIENT_SECRET: 'dropbox-app-secret',
    CDFIR_DROPBOX_REDIRECT_PATH: '/api/v1/connectors/callback/dropbox',
    CDFIR_DROPBOX_API_BASE_URL: 'https://dropbox-api.test/2',
    CDFIR_DROPBOX_CONTENT_BASE_URL: 'https://dropbox-content.test/2',
    CDFIR_DROPBOX_OAUTH_TOKEN_URL: 'https://dropbox-api.test/oauth2/token',
